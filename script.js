...
const opcoesCores = [verdeCipreste, azulInverno, meiaNoite, estelar, rosaClaro]; // uma lista com os meus objetos //
...
function trocarTamanho() {
    // atualizar variável de controle do tamanho da caixa - tamanhoSelecionado //
    const idOpcaoSelecionada = document.querySelector('[name="opcao-tamanho"]:checked').id;
    tamanhoSelecionado = idOpcaoSelecionada.charAt(0);
    // mudar o título do produto de acordo com a opção selecionada //
